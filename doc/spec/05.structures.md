...
definition
  ...
  inherit NonConstPolyStr from PolyStr where
    ...
    proof
      ...
      :: Must prove: P.degree is non zero Nat
      thus P.degree is non zero Nat ...;
    end;
  end;
end;
```
...
definition
  ...
  inherit RingStr from MulStr where
    ...
    proof
      ...
      thus for R being RingStr holds R.carrier is set;
    end;
  end;
end;
```
...
:: carrier can be inferred from the type of f : BinOp of carrier
let m = MagmaStr(binop: f);
```
