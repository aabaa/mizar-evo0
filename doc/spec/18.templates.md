...
`let T be type extends M` declares a **bounded type variable**: T ranges over any structure that inherits from M (via the `inherit ... from ...` chain), rather than a specific instance of M.
