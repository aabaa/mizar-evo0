...
> [!NOTE]
> For structure definition syntax, see [Chapter 7 (Structures)](./07.structures.md).
> For algorithm blocks and `var` declarations, see [Chapter 21 (Algorithm and Verification)](./21.algorithm_and_verification.md).
...
field_assignment     ::= field_name ":" term_expression ;
selector_access      ::= term_expression "." field_name ;
(* For field_decl with optional defaults, see Chapter 7 (Structures) *)
