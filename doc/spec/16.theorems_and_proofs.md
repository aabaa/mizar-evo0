...
> [!NOTE]
> For ATP integration, solver selection, and hint annotations (e.g., `@[hint]`, `@[simp]`), see [Chapter 23 (Source Code Annotation and ATP Integration)](./23.source_code_annotation.md).
