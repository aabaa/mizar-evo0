...
* **`scheme`**: A parameterized reasoning template (e.g., induction schemes). Syntax and semantics are detailed in **Chapter 19**.
...
### 16.4.2. Scope and Visibility
  ...
  * **Shadowing**: Local declarations shadow global symbols and outer-scope variables, following standard lexical scoping rules (see [Chapter 4, §4.6](./04.variables_and_constants.md#46-scoping-and-shadowing)).
