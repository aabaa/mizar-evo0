...
Clustering mechanism is discussed in more detail in a later chapter.
...
3. **Constructor-based Inference**:
   ```mizar
   let A,B be AbelianGroup;
   thus A x B is commutative;  :: inferred through functorial cluster
   ```
